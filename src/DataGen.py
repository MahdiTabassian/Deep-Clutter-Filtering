"""
A module for generating batches of 3D images.
Depending on the choice of using 'deep supervision' in the network's architecture or not, 
the generated batches could be in the form of single or multiple input-output data.  
"""
import os
import numpy as np
import random
...
class DataGen(tf.keras.utils.Sequence):
    """ 
    Generating batches of input cluttered volumes and theier corresponding
